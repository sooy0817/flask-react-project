...
from attachment_converter import convert_and_update_attachments


# 디렉토리 설정
base_dir = os.getcwd()
html_dir =  "woori_temp_html"
pdf_dir =  "woori_pdfs"
    ...
    try:
        ...
        for a in attachment_links:
            ...
            if new_files:
                ...
                bank_name = "woori"
                file_url = f"/files/{bank_name}/{file_name}"
